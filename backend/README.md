...
ASP.NET Core Web API backend that provides semantic search and question answering capabilities for PDF documents using Semantic Kernel, OpenAI embeddings, and configurable LLM provider (OpenAI or Groq).
...
5. Send context + question to LLM (OpenAI or Groq, configurable)
