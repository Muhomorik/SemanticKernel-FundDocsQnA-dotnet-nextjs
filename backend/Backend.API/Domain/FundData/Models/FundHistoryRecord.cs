...
{
    /// <summary>Unique identifier. Auto-generated by the database.</summary>
    public FundHistoryRecordId Id { get; init; }

    /// <summary>Fund identifier (ISIN). Foreign key to <see cref="FundProfile"/>.</summary>
    public required IsinId IsinId { get; init; }

    /// <summary>Net asset value per share at the time of recording.</summary>
    public decimal? Nav { get; init; }

    /// <summary>Date when NAV was calculated. One NAV per fund per day.</summary>
    public DateOnly? NavDate { get; init; }

    /// <summary>Total assets under management at the time of recording.</summary>
    public decimal? Capital { get; init; }

    /// <summary>Number of unique investors holding the fund at the time of recording.</summary>
    public int? NumberOfOwners { get; init; }

    /// <summary>Risk level (1-7, SRRI/SRI indicator) at the time of recording.</summary>
    public int? Risk { get; init; }

    /// <summary>Sharpe ratio (risk-adjusted return) at the time of recording.</summary>
    public decimal? SharpeRatio { get; init; }

    /// <summary>Standard deviation (annualized volatility) at the time of recording.</summary>
    public decimal? StandardDeviation { get; init; }

    /// <summary>Navigation property to parent fund profile.</summary>
