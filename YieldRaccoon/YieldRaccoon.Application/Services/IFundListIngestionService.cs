...
/// </para>
/// </remarks>
public interface IFundListIngestionService
{
    /// <summary>
    ...
    Task<int> IngestBatchAsync(IEnumerable<FundListDataDto> fundDataList, CancellationToken cancellationToken = default);
}
