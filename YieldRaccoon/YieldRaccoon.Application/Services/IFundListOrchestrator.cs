...
/// </para>
/// </remarks>
public interface IFundListOrchestrator : IDisposable
{
    #region Commands

    /// <summary>
    /// Starts a new fund list session with pre-scheduled batch timings.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// <remarks>
    /// <para>
    /// Stops any active countdown timer and appends <c>FundListSessionCancelled</c> event.
    /// </para>
    /// </remarks>
    ...
    /// <list type="bullet">
    ///   <item>Persist the fund data via <see cref="IFundListIngestionService"/></item>
    ///   <item>Append <c>FundListBatchCompleted</c> event</item>
    ...
    Task NotifyBatchLoadedAsync(IReadOnlyCollection<FundListDataDto> funds, int totalFundsLoaded, bool hasMore);
    ...
    /// <remarks>
    /// <para>
    /// Use this method when funds are received outside of an active fund list session,
    ...
    Task<int> IngestFundsAsync(IReadOnlyCollection<FundListDataDto> funds);
    ...
    /// </para>
    /// <para>
    /// Emits <see cref="FundListSessionState.Inactive"/> when no session is active.
    /// </para>
    /// </remarks>
    IObservable<FundListSessionState> SessionState { get; }
    ...
    /// </para>
    /// </remarks>
    IObservable<IReadOnlyList<FundListScheduledBatchItem>> ScheduledBatches { get; }
    ...
    /// </para>
    /// </remarks>
    IObservable<FundListCountdownTick> CountdownTick { get; }
    ...
    /// </para>
    /// </remarks>
    IObservable<FundListBatchNumber> LoadBatchRequested { get; }
    ...
    /// </para>
    /// </remarks>
    IObservable<FundListSessionCompletedInfo> SessionCompleted { get; }
