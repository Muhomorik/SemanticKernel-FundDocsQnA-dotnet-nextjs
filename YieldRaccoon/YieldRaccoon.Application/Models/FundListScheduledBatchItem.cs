...
public sealed record FundListScheduledBatchItem
{
    /// <summary>
    ...
    /// </summary>
    public required FundListBatchStatus Status { get; init; }
    ...
    public TimeSpan? TimeUntilScheduled =>
        Status == FundListBatchStatus.Pending && ScheduledAt > DateTimeOffset.UtcNow
...
/// </summary>
public enum FundListBatchStatus
{
    /// <summary>
