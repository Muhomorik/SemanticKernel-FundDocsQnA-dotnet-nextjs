...
[TestFixture]
[TestOf(typeof(ApiFundDtoMapper))]
public class ApiFundDtoMapperTests
{
    ...
    [Test]
    public void ToApiFundDto_FundDataDto_MapsAllProperties()
    {
        // Arrange
        var dto = new FundDataDto
        {
            Isin = "SE0001234567",
            Name = "Test Fund",
            OrderbookId = "123456",
    ...
    [Test]
    public void ToApiFundDto_FundProfile_MapsIsinIdToString()
    {
        // Arrange
        ...
        // Act
        var result = profile.ToApiFundDto();
    ...
    [Test]
    public void ToApiFundDto_FundProfile_MapsDateOnlyToString()
    {
        // Arrange
        var profile = new FundProfile
        {
    ...
    [Test]
    public void ToApiFundDto_FundProfile_NullStartDate_MapsToNull()
    {
        // Arrange
        var profile = new FundProfile
        {
    ...
    [Test]
    public void ToApiFundDtos_FiltersNullIsinAndName()
    {
        // Arrange
        var dtos = new List<FundDataDto>
        {
