...
/// <summary>
/// Schedules fund list sessions with pre-calculated batch timings using randomized delays.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public class FundListSessionScheduler : IFundListSessionScheduler
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FundListSessionScheduler"/> class.
    /// </summary>
    /// <param name="eventStore">The event store for appending scheduled events.</param>
    public FundListSessionScheduler(IFundListEventStore eventStore)
    {
        _eventStore = eventStore ?? throw new ArgumentNullException(nameof(eventStore));
    }

    /// <inheritdoc/>
    public FundListSessionId ScheduleSession(int expectedBatchCount)
    {
        ...
        var sessionId = FundListSessionId.NewId();
        var totalSeconds = 0;
