...
/// <remarks>
/// <para>
/// This service orchestrates the mapping of <see cref="FundListDataDto"/> to domain entities:
/// <list type="bullet">
...
/// </para>
/// </remarks>
public class FundListIngestionService : IFundListIngestionService
{
    private readonly IFundProfileRepository _profileRepository;
    private readonly IFundHistoryRepository _historyRepository;

    /// <summary>
    /// Initializes a new instance of the <see cref="FundListIngestionService"/> class.
    /// </summary>
    ...
    public FundListIngestionService(
    ...
    public async Task<int> IngestBatchAsync(
        IEnumerable<FundListDataDto> fundDataList,
    ...
    private static FundProfile CreateProfile(FundListDataDto dto, IsinId isinId, DateTimeOffset now)
    {
    ...
    private static FundHistoryRecord CreateHistoryRecord(FundListDataDto dto, IsinId isinId)
    {
