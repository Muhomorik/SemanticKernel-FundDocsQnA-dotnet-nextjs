...
/// <summary>
/// ViewModel wrapper for <see cref="FundListInterceptedFund"/> that implements INotifyPropertyChanged
/// for proper WPF data binding and change notification.
/// </summary>
public class FundListInterceptedFundViewModel : BindableBase
{
    /// <summary>
    ...
    /// <summary>
    /// Updates this ViewModel from an <see cref="FundListInterceptedFund"/> model.
    /// </summary>
    /// <param name="fund">The source fund to update from.</param>
    public void UpdateFrom(FundListInterceptedFund fund)
    {
        Isin = fund.Isin;
        Name = fund.Name;
        Nav = fund.Nav;
    ...
    /// <summary>
    /// Creates a new <see cref="FundListInterceptedFundViewModel"/> from an <see cref="FundListInterceptedFund"/>.
    /// </summary>
    /// <param name="fund">The source fund.</param>
    /// <returns>A new ViewModel instance.</returns>
    public static FundListInterceptedFundViewModel FromModel(FundListInterceptedFund fund)
    {
        var vm = new FundListInterceptedFundViewModel();
        vm.UpdateFrom(fund);
        return vm;
    }
}
