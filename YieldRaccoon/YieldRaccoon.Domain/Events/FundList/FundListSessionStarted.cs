...
/// </para>
/// </remarks>
[DebuggerDisplay("FundListSessionStarted: Session={SessionId}, Funds={TotalFundCount}, Batches≈{EstimatedBatchCount}, Duration≈{EstimatedDurationSeconds}s at {OccurredAt}")]
public sealed record FundListSessionStarted : IFundListEvent
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new <see cref="FundListSessionStarted"/> event with UTC timestamp.
    /// </summary>
    ...
    public static FundListSessionStarted Create(
    ...
    {
        return new FundListSessionStarted
        {
            SessionId = sessionId,
