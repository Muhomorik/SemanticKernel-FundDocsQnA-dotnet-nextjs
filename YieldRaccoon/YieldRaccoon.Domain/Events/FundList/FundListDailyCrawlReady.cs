...
/// <remarks>
/// <para>
/// Published when the scheduled time (from <see cref="FundListDailyCrawlScheduled.ScheduledTime"/>) is reached.
...
/// </list>
/// </remarks>
[DebuggerDisplay("FundListDailyCrawlReady at {OccurredAt}")]
public sealed record FundListDailyCrawlReady : IFundListEvent
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new <see cref="FundListDailyCrawlReady"/> event with UTC timestamp.
    /// </summary>
    /// <returns>A new immutable event instance.</returns>
    public static FundListDailyCrawlReady Create()
    {
        return new FundListDailyCrawlReady
        {
