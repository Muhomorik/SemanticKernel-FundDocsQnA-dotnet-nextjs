...
/// <remarks>
/// <para>
/// Published after <see cref="FundListSessionCompleted"/> to schedule the next daily crawl
...
///   <item><description>When timer elapses, <see cref="FundListDailyCrawlReady"/> is published</description></item>
/// </list>
/// </remarks>
[DebuggerDisplay("FundListDailyCrawlScheduled: ScheduledTime={ScheduledTime} at {OccurredAt}")]
public sealed record FundListDailyCrawlScheduled : IFundListEvent
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new <see cref="FundListDailyCrawlScheduled"/> event with UTC timestamp.
    /// </summary>
    ...
    public static FundListDailyCrawlScheduled Create(DateTimeOffset scheduledTime)
    {
        return new FundListDailyCrawlScheduled
        {
