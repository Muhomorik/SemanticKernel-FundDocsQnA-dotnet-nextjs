...
/// </list>
/// </remarks>
[DebuggerDisplay("FundListSessionCancelled: Session={SessionId}, FundsLoaded={FundsLoadedSoFar}, Reason={Reason} at {OccurredAt}")]
public sealed record FundListSessionCancelled : IFundListEvent
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new <see cref="FundListSessionCancelled"/> event with UTC timestamp.
    /// </summary>
    ...
    public static FundListSessionCancelled Create(
        ...
        DateTimeOffset startedAt)
    {
        ...
        return new FundListSessionCancelled
        {
            SessionId = sessionId,
