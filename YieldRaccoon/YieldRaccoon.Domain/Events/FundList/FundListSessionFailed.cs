...
/// that triggers <see cref="FundListSessionCompleted"/> instead.
/// </para>
/// </remarks>
[DebuggerDisplay("FundListSessionFailed: Session={SessionId}, Reason={FailureReason}, LastBatch={LastCompletedBatch} at {OccurredAt}")]
public sealed record FundListSessionFailed : IFundListEvent
{
    /// <summary>
    ...
    /// </remarks>
    public FundListBatchNumber? LastCompletedBatch { get; init; }
    ...
    /// <summary>
    /// Creates a new <see cref="FundListSessionFailed"/> event with UTC timestamp.
    /// </summary>
    ...
    public static FundListSessionFailed Create(
        FundListSessionId sessionId,
        string failureReason,
        DateTimeOffset startedAt,
        FundListBatchNumber? lastCompletedBatch = null)
    {
        var now = DateTimeOffset.UtcNow;
        return new FundListSessionFailed
        {
            SessionId = sessionId,
