...
/// </para>
/// </remarks>
[DebuggerDisplay("FundListBatchCompleted: Session={SessionId}, Batch={BatchNumber}, Funds={FundsInBatch}, Total={TotalFundsLoaded} at {OccurredAt}")]
public sealed record FundListBatchCompleted : IFundListEvent
{
    /// <summary>
    /// Gets the unique correlation ID for the crawl session, or null for manual clicks.
    /// </summary>
    public FundListSessionId? SessionId { get; init; }
    ...
    /// <summary>
    /// Creates a new <see cref="FundListBatchCompleted"/> event with UTC timestamp.
    /// </summary>
