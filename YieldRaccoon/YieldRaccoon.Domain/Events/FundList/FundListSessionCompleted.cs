...
/// <list type="bullet">
///   <item><description>Publish <see cref="FundListDailyCrawlScheduled"/> to schedule next crawl ~24 hours later (19:00-21:00 window).</description></item>
///   <item><description>Persist fund data to database.</description></item>
/// </list>
/// </remarks>
[DebuggerDisplay("FundListSessionCompleted: Session={SessionId}, Funds={TotalFundsLoaded}, Batches={TotalBatchesLoaded}, Duration={Duration} at {OccurredAt}")]
public sealed record FundListSessionCompleted : IFundListEvent
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the timestamp when the session started (from FundListSessionStarted.OccurredAt).
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="FundListSessionCompleted"/> event with UTC timestamp.
    /// </summary>
    ...
    public static FundListSessionCompleted Create(
        ...
        IReadOnlyList<DateTimeOffset> batchLoadTimestamps)
    {
        ...
        return new FundListSessionCompleted
        {
            SessionId = sessionId,
