...
/// </para>
/// </remarks>
[DebuggerDisplay("FundListBatchScheduled: Session={SessionId}, Batch={BatchNumber}, Delay={DelaySeconds}s at {OccurredAt}")]
public sealed record FundListBatchScheduled : IFundListEvent
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new <see cref="FundListBatchScheduled"/> event with UTC timestamp.
    /// </summary>
    ...
    public static FundListBatchScheduled Create(
        FundListSessionId sessionId,
        FundListBatchNumber batchNumber,
        int delaySeconds)
    {
        return new FundListBatchScheduled
        {
            SessionId = sessionId,
